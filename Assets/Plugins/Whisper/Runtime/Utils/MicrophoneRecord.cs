...
namespace Whisper.Utils
{
    ...
    public class MicrophoneRecord : MonoBehaviour
    {
        ...
        public float chunksLengthSec = 0.1f;
        ...
        public string SelectedMicDevice
        {
            ...
            set
            {
                _selectedMicDevice = AvailableMicDevices.ToList()[Int32.Parse(value)] ;
                UnityEngine.Debug.Log("Changed to: " + _selectedMicDevice);
        ...
        private void Awake()
        {
            ...
            string micOptions = "";
            foreach (string s in AvailableMicDevices.ToList())
            {
                micOptions = micOptions + ", " + s;
            }

            UnityEngine.Debug.Log("Your option are: " + micOptions);
            SelectedMicDevice = "0";
        }
        ...
        public void StartRecord()
        {
            ...
            {
                UnityEngine.Debug.Log("Your option are: " + AvailableMicDevices.ToList());
                return;
            }
