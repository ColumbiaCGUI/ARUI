...
public class ListMenuObjs : MonoBehaviour
{
    ...
    void Update()
    {
        if (EyeGazeManager.Instance.CurrentHit != EyeTarget.listmenuButton_items)
        {
        ...
        else if (EyeGazeManager.Instance.CurrentHit == EyeTarget.listmenuButton_items)
        {
            delta = 0.0f;
            FadeIn();
        }
