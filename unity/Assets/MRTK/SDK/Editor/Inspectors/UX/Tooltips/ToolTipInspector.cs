    ...
    public class ToolTipInspector : UnityEditor.Editor
    {
        ...
        protected virtual void OnSceneGUI()
        {
            ...
            if (DrawHandles)
            {
                ...
                var fmh_252_90_638688629730938356 = Quaternion.identity; Vector3 newPivotPosition = Handles.FreeMoveHandle(toolTip.PivotPosition, handleSize, Vector3.zero, Handles.SphereHandleCap);
                ...
                arrowSize = handleSize * 2;
                var fmh_263_92_638688629730940720 = Quaternion.identity; Vector3 newAnchorPosition = Handles.FreeMoveHandle(toolTip.AnchorPosition, HandleUtility.GetHandleSize(toolTip.AnchorPosition) * handleSizeMultiplier, Vector3.zero, Handles.SphereHandleCap);
                ...
                if (EditAttachPoint)
                {
                    ...
                    arrowSize = handleSize * 2;
                    var fmh_293_106_638688629730943100 = Quaternion.identity; Vector3 newAttachPointPosition = Handles.FreeMoveHandle(toolTip.AttachPointPosition, HandleUtility.GetHandleSize(toolTip.AttachPointPosition) * handleSizeMultiplier, Vector3.zero, Handles.SphereHandleCap);
